return {
  ...
  after = function(plugin)
    ...
    require('gitsigns').setup({
      signs                        = {
        add          = { text = ui.add, },
        change       = { text = ui.change, },
        delete       = { text = ui.delete, },
        topdelete    = { text = ui.topdelete, },
        changedelete = { text = ui.changedelete, },
        untracked    = { text = ui.untracked, },
      },
      signs_staged                 = {
        add          = { text = ui.add, },
        change       = { text = ui.change, },
    ...
    vim.api.nvim_set_hl(0, "GitSignsChange", { fg = colors.teal })
