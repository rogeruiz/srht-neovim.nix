  ...
  require('catppuccin').setup {
    ...
    custom_highlights = function(colors)
      return {
        ...
        -- Pa' Avante
        AvanteConflictCurrent            = { fg = colors.red },
        AvanteConflictCurrentLabel       = { fg = colors.red },
        AvanteConflictIncoming           = { fg = colors.green },
        AvanteConflictIncomingLabel      = { fg = colors.green },
        AvanteToBeDeletedWOStrikethrough = { fg = colors.red },
      }
    end,
    integrations = {
      cmp = true,
